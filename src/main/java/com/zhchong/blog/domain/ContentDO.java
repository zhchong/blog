package com.zhchong.blog.domain;
...
public class ContentDO implements Serializable {
	...
	public Integer getAllowReward() {
		return allowReward;
	}
	public void setAllowReward(Integer allowReward) {
	...
	public Integer getIssueForm() {
		return issueForm;
	}
	public void setIssueForm(Integer issueForm) {
