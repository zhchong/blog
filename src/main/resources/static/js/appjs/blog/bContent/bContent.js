			...
			.bootstrapTable(
					{
						...
						columns : [
                                ...
                                },
								{
									...
									formatter : function(value, row, index) {
										var html = '';
										for(var i=0; i<row.tagsName.length; i++){
											html += '<span class="label label-primary">'+row.tagsName[i]+'</span>&nbsp;'
										}
										return html;
									}
								},
								{
									...
									formatter : function(value, row, index) {
										var html = '';
										for(var i=0; i<row.categoriesName.length; i++){
											html += '<span class="label label-warning">'+row.categoriesName[i]+'</span>&nbsp;'
										}
										return html;
									}
								},
								{
									...
									title : '发布形式',
									formatter : function(value, row, index) {
										return '<span class="label label-success">'+row.issueFormName+'</span>&nbsp;'
									}
								},
								{
									field : 'type',
									...
									title : '文章类型',
									formatter : function(value, row, index) {
										return '<span class="label label-info">'+row.typeName+'</span>&nbsp;'
									}
								},
								{
									field : 'sort',
